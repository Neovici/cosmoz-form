import{e as Q,i as j,a as V,o as v,l as G,r as H,c as R,u as P,b as L,d as A,f as q,g as x,n as Y,h as B}from"./inline-file-rmqU3dZF.js";import{E,b as d}from"./iframe-DWO7Awwg.js";import"./preload-helper-PPVm8Dsz.js";const J={},K=Q(class extends j{constructor(){super(...arguments),this.ot=J}render(t,e){return e()}update(t,[e,r]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((n,s)=>n===this.ot[s]))return E}else if(this.ot===e)return E;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,r)}}),W=V(({id:t,label:e,noLabelFloat:r,alwaysFloatLabel:n,error:s,warning:l,suffix:u,disabled:a,onChange:p,options:o,limit:c,min:i,textProperty:w,valueProperty:h,value:f,values:b,itemRenderer:y,keepOpened:_,keepQuery:k,placeholder:S,wrap:F,showSingle:D,preserveOrder:O,title:C,textual:U,description:M,externalSearch:z,...N})=>d`<cosmoz-autocomplete
...
// form.processing → true while fetching, false when settled`}}};const ae={quantity:1,unitPrice:0,total:0,_pricingLoading:!1},ie=async(t,e)=>(await I(t,1e3),e>=50?8:e>=20?9.5:e>=10?11:13.5),oe=[{id:"quantity",label:"Quantity",input:Y,min:1,max:100,step:"1"},{id:"unitPrice",label:"Unit price (€)",disabled:!0,suffix:(t,e)=>B(e._pricingLoading,()=>d`<cosmoz-spinner></cosmoz-spinner>`)},{id:"total",label:"Total (€)",disabled:!0,rules:[[({quantity:t,unitPrice:e})=>({total:Math.round(t*e*100)/100}),({quantity:t,unitPrice:e})=>[t,e]]]},{id:"_pricingLoading",hidden:!0}],le=()=>{const t=P({started:0,resolved:0}),[,e]=L(0),r=A(()=>[async(a,{update:p,signal:o})=>{if(!a.quantity)return{unitPrice:0,_pricingLoading:!1};t.current.started++,e(i=>i+1),p({_pricingLoading:!0});const c=await ie(o,a.quantity);return t.current.resolved++,e(i=>i+1),{unitPrice:c,_pricingLoading:!1}},({quantity:a})=>[a],()=>X(500)],[]),n=q({fields:oe,initial:ae,asyncRules:[r]}),{started:s,resolved:l}=t.current,u=s-l;return d`
        ${T}
        <div class="story-wrap">
            ${x(n)}
            <p class="story-hint">
