...
`,Fo=["variant","size","disabled","full-width","type"],Do=e=>{const t=e.hasAttribute("disabled"),o=e.getAttribute("type")||"button";return x(()=>{const n=s=>{e.hasAttribute("disabled")&&s.stopImmediatePropagation()};return e.addEventListener("click",n,{capture:!0}),()=>e.removeEventListener("click",n,{capture:!0})},[]),m`
...
`;const xe=e=>e?Array.isArray(e)?e.length===1?e[0].name:rt("{0} files",{0:e.length}):e.name:rt("Choose file"),Mr=Gt(({id:e,label:t,value:o,values:n,onChange:s,accept:r,multiple:i,disabled:a})=>m`<div class="input input-inline-file" name=${e}>
			...
			/>
		</div>`);export{Lr as A,j as B,is as C,Or as D,Mn as E,N as F,vs as G,ge as H,Ut as I,lt as J,x as K,Et as L,fe as M,_ as N,Tr as a,De as b,st as c,Gt as d,jn as e,Hn as f,qn as g,C as h,O as i,Sr as j,as as k,At as l,ut as m,z as n,b as o,M as p,gs as q,Un as r,Rr as s,nt as t,Wt as u,os as v,he as w,Fe as x,Ar as y,Mr as z};
