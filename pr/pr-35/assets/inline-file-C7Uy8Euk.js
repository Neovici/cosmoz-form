import{A as V,w as re,b as p,r as St,D as At,E as N,n as bo,M as yo,u as K,v as ce,h as Be,p as Tt,t as me}from"./iframe-BuoKl6_M.js";import{_ as zo}from"./preload-helper-PPVm8Dsz.js";const y=t=>t??V;function _(t,e,o){return t?e(t):o?.(t)}const wo=({slot:t,title:e,className:o,width:n="24",height:s="24",styles:r}={})=>p`
  <svg
    slot=${y(t)}
...
`;let ke,Lt=0;function tt(t){ke=t}function ot(){ke=null,Lt=0}function Co(){return Lt++}const Fe=Symbol("haunted.phase"),$e=Symbol("haunted.hook"),nt=Symbol("haunted.update"),st=Symbol("haunted.commit"),Q=Symbol("haunted.effects"),he=Symbol("haunted.layoutEffects"),He="haunted.context";class ko{update;host;virtual;[$e];[Q];[he];constructor(e,o){this.update=e,this.host=o,this[$e]=new Map,this[Q]=[],this[he]=[]}run(e){tt(this);let o=e();return ot(),o}_runEffects(e){let o=this[e];tt(this);for(let n of o)n.call(this);ot()}runEffects(){this._runEffects(Q)}runLayoutEffects(){this._runEffects(he)}teardown(){this[$e].forEach(o=>{typeof o.teardown=="function"&&o.teardown(!0)})}}const So=Promise.resolve().then.bind(Promise.resolve());function Ot(){let t=[],e;function o(){e=null;let n=t;t=[];for(var s=0,r=n.length;s<r;s++)n[s]()}return function(n){t.push(n),e==null&&(e=So(o))}}const Ao=Ot(),rt=Ot();class To{renderer;host;state;[Fe];_updateQueued;_active;constructor(e,o){this.renderer=e,this.host=o,this.state=new ko(this.update.bind(this),o),this[Fe]=null,this._updateQueued=!1,this._active=!0}update(){this._active&&(this._updateQueued||(Ao(()=>{let e=this.handlePhase(nt);rt(()=>{this.handlePhase(st,e),rt(()=>{this.handlePhase(Q)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,o){switch(this[Fe]=e,e){case st:this.commit(o),this.runEffects(he);return;case nt:return this.render();case Q:return this.runEffects(Q)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const fe=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},Ro=t=>t?.map(e=>typeof e=="string"?fe(e):e),Lo=(t,...e)=>t.flatMap((o,n)=>[o,e[n]||""]).join(""),T=Lo,Oo=(t="")=>t.replace(/-+([a-z])?/g,(e,o)=>o?o.toUpperCase():"");function Mo(t){class e extends To{frag;renderResult;constructor(s,r,i){super(s,i||r),this.frag=r}commit(s){this.renderResult=t(s,this.frag)}}function o(n,s,r){const i=(r||s||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:h}=r||s||{},d=Ro(n.styleSheets||h);class g extends i{_scheduler;static get observedAttributes(){return n.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new e(n,this);else{const b=this.attachShadow({mode:"open",...c});d&&(b.adoptedStyleSheets=d),this._scheduler=new e(n,b,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(b,f,A){if(f===A)return;let $=A===""?!0:A;Reflect.set(this,Oo(b),$)}}function u(m){let b=m,f=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return b},set(A){f&&b===A||(f=!0,b=A,this._scheduler&&this._scheduler.update())}})}const v=new Proxy(i.prototype,{getPrototypeOf(m){return m},set(m,b,f,A){let $;return b in m?($=Object.getOwnPropertyDescriptor(m,b),$&&$.set?($.set.call(A,f),!0):(Reflect.set(m,b,f,A),!0)):(typeof b=="symbol"||b[0]==="_"?$={enumerable:!0,configurable:!0,writable:!0,value:f}:$=u(f),Object.defineProperty(A,b,$),$.set&&$.set.call(A,f),!0)}});return Object.setPrototypeOf(g.prototype,v),g}return o}class G{id;state;constructor(e,o){this.id=e,this.state=o}}function Io(t,...e){let o=Co(),n=ke[$e],s=n.get(o);return s||(s=new t(o,ke,...e),n.set(o,s)),s.update(...e)}function W(t){return Io.bind(null,t)}function Mt(t){return W(class extends G{callback;lastValues;values;_teardown;constructor(e,o,n,s){super(e,o),t(o,this)}update(e,o){this.callback=e,this.values=o}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,o)=>this.lastValues[o]!==e)}})}function It(t,e){t[Q].push(e)}const x=Mt(It),Po=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,Pt=W(class extends G{Context;value;_ranEffect;_unsubscribe;constructor(t,e,o){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,It(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};Po(this.state.host).dispatchEvent(new CustomEvent(He,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:n=null,value:s}=e;this.value=n?s:t.defaultValue,this._unsubscribe=n}teardown(){this._unsubscribe&&this._unsubscribe()}});function No(t){return e=>{const o={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(He,this)}disconnectedCallback(){this.removeEventListener(He,this)}handleEvent(n){const{detail:s}=n;s.Context===o&&(s.value=this.value,s.unsubscribe=this.unsubscribe.bind(this,s.callback),this.listeners.add(s.callback),n.stopPropagation())}unsubscribe(n){this.listeners.delete(n)}set value(n){this._value=n;for(let s of this.listeners)s(n)}get value(){return this._value}},Consumer:t(function({render:n}){const s=Pt(o);return n(s)},{useShadowDOM:!1}),defaultValue:e};return o}}const S=W(class extends G{value;values;constructor(t,e,o,n){super(t,e),this.value=o(),this.values=n}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,o)=>this.values[o]!==e)}}),w=(t,e)=>S(()=>t,e);function Vo(t,e){t[he].push(e)}const it=Mt(Vo),H=W(class extends G{args;constructor(t,e,o){super(t,e),this.updater=this.updater.bind(this),typeof o=="function"&&(o=o()),this.makeArgs(o)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}}),Bo=W(class extends G{reducer;currentState;constructor(t,e,o,n,s){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=s!==void 0?s(n):n}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}}),Fo=/([A-Z])/gu,ve=W(class extends G{property;eventName;constructor(t,e,o,n){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=o,this.eventName=o.replace(Fo,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof n=="function"&&(n=n()),n!=null&&this.updateProp(n))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}});function M(t){return S(()=>({current:t}),[])}function jo({render:t}){const e=Mo(t),o=No(e);return{component:e,createContext:o}}const j={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},ee=t=>(...e)=>({_$litDirective$:t,values:e});let be=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,o,n){this._$Ct=e,this._$AM=o,this._$Ci=n}_$AS(e,o){return this.update(e,o)}update(e,o){return this.render(...o)}};const ue=(t,e)=>{const o=t._$AN;if(o===void 0)return!1;for(const n of o)n._$AO?.(e,!1),ue(n,e);return!0},Se=t=>{let e,o;do{if((e=t._$AM)===void 0)break;o=e._$AN,o.delete(t),t=e}while(o?.size===0)},Nt=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(o===void 0)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),qo(e)}};function Do(t){this._$AN!==void 0?(Se(this),this._$AM=t,Nt(this)):this._$AM=t}function Ho(t,e=!1,o=0){const n=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(n))for(let r=o;r<n.length;r++)ue(n[r],!1),Se(n[r]);else n!=null&&(ue(n,!1),Se(n));else ue(this,t)}const qo=t=>{t.type==j.CHILD&&(t._$AP??=Ho,t._$AQ??=Do)};class Ge extends be{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,o,n){super._$AT(e,o,n),Nt(this),this.isConnected=e._$AU}_$AO(e,o=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),o&&(ue(this,e),Se(this))}setValue(e){if(St(this._$Ct))this._$Ct._$AI(e,this);else{const o=[...this._$Ct._$AH];o[this._$Ci]=e,this._$Ct._$AI(o,this,0)}}disconnected(){}reconnected(){}}const{component:L,createContext:Yo}=jo({render:At}),Uo=T`
	@keyframes rotating {
		100% {
...
`,Go=()=>V,Wo=L(Go,{styleSheets:[Uo]});customElements.define("cosmoz-spinner",Wo);const ie=fe(T`
	/*
...
`,ae=W(class extends G{update(){return this.state.host}}),tn=()=>{const t=ae(),e=w(()=>{t.dispatchEvent(new Event("close")),t.onClose?.()},[]);return x(()=>{const o=t.shadowRoot;if(!o)return;const n=s=>s.target.value==="cancel"&&e();return o.addEventListener("click",n),()=>{o.removeEventListener("click",n)}},[]),{close:e}},on=(t,e,o)=>{const n=t.width/3,s=t.height/3,r=Math.min(window.innerWidth-2*n,Math.max(-n,e)),i=Math.min(window.innerHeight-2*s,Math.max(-s,o));return{x:r,y:i}},nn=(t,e,o,n)=>s=>{if(!s.target.closest(e))return;const r=on,i=t.getBoundingClientRect(),a=s.clientX-i.x,l=s.clientY-i.y,c=(g,u)=>{const v=g-a,m=u-l,b=r(i,v,m);Object.assign(t.style,{inset:"auto",margin:"0",left:b.x+"px",top:b.y+"px",transform:"none"})},h=g=>c(g.clientX,g.clientY),d=g=>{document.removeEventListener("mousemove",h),document.removeEventListener("mouseup",d)};document.addEventListener("mousemove",h),document.addEventListener("mouseup",d)},sn=()=>{const t=ae(),{unmovable:e}=t;x(()=>{if(e)return;const o=t.shadowRoot;if(!o)return;const n=o.querySelector("dialog");if(!n)return;const s=nn(n,".title");return o.addEventListener("mousedown",s),()=>o.removeEventListener("mousedown",s)},[e])},rn=({title:t,subtitle:e,icon:o,content:n,closeable:s=!1,onClose:r})=>p`
	...
	`,We=(t,{observedAttributes:e,styles:o,...n}={})=>L(s=>{const{close:r}=tn();sn();const i=M();return p`
			...
			`},{observedAttributes:["title","subtitle","icon","heading","unmovable","closeable",...e??[]],styleSheets:[ie,en],...n});customElements.define("cosmoz-dialog-loading",We(()=>p`
			<style>
				.content {
					flex-direction: row;
					align-items: center;
...
`;customElements.define("cosmoz-tooltip-content",L(()=>p`
			...
			<slot></slot>
		`,{styleSheets:[ie,gn]}));const qe=fe(T`
...
`,yn=t=>{const{heading:e,description:o,for:n,placement:s="top",delay:r=300,disabled:i=!1}=t,a=M(),l=M(),c=M(),h=vn(c),g=!!(e||o||h)&&!i,u=w(()=>{g&&(clearTimeout(l.current),l.current=window.setTimeout(()=>{a.current?.showPopover()},r))},[r,g]);x(()=>{i&&(clearTimeout(l.current),a.current?.hidePopover())},[i]);const v=w(()=>{clearTimeout(l.current),a.current?.hidePopover()},[]);return x(()=>{if(n)return;const m=b=>{const f=b.relatedTarget;f&&t.contains(f)||v()};return t.addEventListener("pointerover",u),t.addEventListener("pointerout",m),()=>{t.removeEventListener("pointerover",u),t.removeEventListener("pointerout",m)}},[n,u,v]),fn(t,{for:n,heading:e,description:o,placement:s,delay:r,disabled:i}),n?V:g?p`
	...
	`:p`
		...
		`};customElements.define("cosmoz-tooltip",L(yn,{styleSheets:[ie,qe,bn],observedAttributes:["heading","description","for","placement","delay","disabled"]}));const Vt=(t,{hint:e,label:o,invalid:n,errorMessage:s,compact:r,required:i})=>p`
	...
	`,Bt=["autocomplete","readonly","disabled","maxlength","invalid"],le=(t,...e)=>t.flatMap((o,n)=>[o,e[n]??""]).join(""),Ft=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},jt=le`
	/* === Host === */
...
`,rs=()=>V,is=(t,e)=>Promise.resolve(t).then(e,e),Ir=({error:t,...e})=>[Gt(e),_(t,o=>p`<div class="failure">${o.message}</div>`)],as=t=>ge(t?.then(rs,e=>p`<div class="failure">${e.message}</div>`),V),ls=({save$:t,progress:e,...o})=>{const n=({onSave:s,onClick:r=s,title:i,disabled:a,progress:l,content:c=V,slot:h})=>p` <cosmoz-button
		...
		>
			${c} ${i}
		</cosmoz-button>`;return ge(is(t,()=>n(o)),n({...o,disabled:!0,progress:!0,content:p`<cosmoz-spinner></cosmoz-spinner> ${_(e,s=>s.join("/"))}`}))},cs=le`
...
`,ds=()=>{let t=null;return{run:async(e,o,n,s)=>{t?.abort(),t=new AbortController;const r={update:n,signal:t.signal,index:s?.index,context:s?.context};try{return await e(o,r)}catch(i){if(i instanceof DOMException&&i.name==="AbortError")return null;throw i}},cancel:()=>{t?.abort(),t=null}}},hs=(t,e)=>t.length!==e.length||t.some((o,n)=>!Object.is(o,e[n])),us=t=>{console.error("[cosmoz-form] async rule error:",t)},ps=(t,e,o)=>{const n=us,s=M(new Map),r=M(new Map),i=M(0),[a,l]=H(!1);return x(()=>()=>{for(const c of s.current.values())c.cancel()},[]),x(()=>{if(!e?.length)return;const c=t.context;for(const h of e){const[d,g,u=ds]=h;s.current.has(h)||s.current.set(h,u());const v=g(t.values,void 0,c),m=r.current.get(h);if(m!=null&&!hs(v,m))continue;r.current.set(h,v);const b=s.current.get(h);i.current++,i.current===1&&l(!0),b.run(d,t.values,f=>t.onChange(f,!1),{context:c}).then(f=>{f!==null&&t.onChange(f,!1)}).catch(f=>n(f,h)).finally(()=>{i.current--,i.current===0&&l(!1)})}},[t.values,t.context]),{...t,processing:a}},Ue=Symbol("touched");function Ce(t,e=!0){if(t==null)return;const o=t;return e?o[Ue]=!0:delete o[Ue],t}const Wt=t=>Ce(t,!1),yt=t=>!!t?.[Ue],ms=(t,e)=>!e||t.some((o,n)=>!Object.is(e[n],o)),de=({oldItem:t,newItem:e,rules:o,index:n,oldIndex:s=n,context:r,oldContext:i=r})=>o?o.reduce((a,[l,c])=>t&&c&&!ms(c(a,n,r),c(t,s,i))?a:{...a,...l(a,t,n,s,r)},e):e,gs=(t,e,o,n,s)=>{const[,r]=t,i=M(void 0);return x(()=>{const a=i.current;i.current=n,a!==void 0&&e(([l,c])=>[l,Ce(de({oldItem:c,newItem:c,rules:o,context:n,oldContext:a}),yt(c))])},[n]),{values:r,context:n??{},onReset:w(()=>e(([a])=>[a,a]),[e]),onValues:w((a,l=!0)=>e(([c,h])=>[c,Ce(de({oldItem:h,newItem:R(a,h),rules:o,context:n}),l)]),[o,e,n]),onChange:w((a,l=!0)=>e(([c,h])=>[c,Ce(de({oldItem:h,newItem:{...h,...R(a,h)},rules:o,context:n}),l)]),[o,e,n]),load:w((a,l)=>{if(!a){e([a,a]);return}const c=Wt(de({oldItem:void 0,newItem:a,rules:l??o,context:n}));e([c,c])},[o,e,n]),touched:S(()=>yt(r)||(s??!1),[r,s])}},fs=(t,e,o)=>Wt(de({oldItem:void 0,newItem:t,rules:e,context:o})),Xt=(t,e=[])=>{const o=t.filter(n=>n?.rules!=null).flatMap(n=>n?.rules);return[...e,...o]},vs=(t,e,{fields:o,rules:n,context:s,touched:r})=>{const i=S(()=>R(o)??[],[o]),a=S(()=>Xt(i,n),[i,n]),l=gs(t,e,a,s,r),{values:c}=l;return{...S(()=>Fn(i,c,s),[i,c,s]),...l}},bs=t=>{const[e,o]=H(()=>{const n=R(t.fields)??[],s=Xt(n,t.rules),r=fs(t.initial,s,t.context);return[r,r]});return vs(e,o,t)};function ys({fields:t,initial:e,rules:o,asyncRules:n,context:s,onSave:r,allowEmpty:i}){const a=bs({fields:t,initial:e,rules:o,context:s}),{processing:l}=ps(a,n),{values:c,invalid:h}=a,[d,g]=H(),[u,v]=H(),m=c==null||c===e,b=a.fields?.length>0&&!(m&&i)&&(m||h);return{...a,save$:d,onSave:w(()=>g(r?.(c,e,v)),[r,c,e]),disabled:b,processing:l,progress:u}}const zs=le`
	.description {
		font-size: var(--cz-text-base);
		line-height: var(--cz-text-base-line-height);
		color: var(--cz-color-text-secondary);
...
`,Zt=t=>{const{auto:e,uncancelable:o,hideCancelButton:n,saveText:s=me("OK")}=t,{onSave:r,disabled:i,save$:a,progress:l,...c}=ys(t);return x(()=>{e&&r()},[e]),p` <style>
			${cs} ${Wn(c)}${zs}
		</style>
...
`,Ws=()=>p`<span class="badge" part="badge" role="status">
		...
		<slot name="suffix"></slot>
	</span>`;customElements.define("cosmoz-badge",L(Ws,{styleSheets:[ie,Gs]}));const Y=t=>`calc(var(--cz-spacing) * ${t})`,Xs=T`
	/* =========================================
	 * HOST
	 * ========================================= */
	:host {
...
`,Zs=t=>{const{color:e,size:o,disabled:n,removable:s}=t,r=()=>{n||t.dispatchEvent(new CustomEvent("remove"))};return p`<cosmoz-badge
	...
	</cosmoz-badge>`};customElements.define("cosmoz-tag",L(Zs,{observedAttributes:["color","size","disabled","removable"],styleSheets:[ie,Xs]}));const Ks=({content:t,onClear:e,disabled:o,className:n="chip",hidden:s,slot:r})=>p`<cosmoz-tag
		class=${y(n)}
		slot=${y(r)}
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",L(()=>V,{styleSheets:[Js]}));const Qt=le`
	:host {
		display: block;
		position: relative;
...
`;const kt=t=>t?Array.isArray(t)?t.length===1?t[0].name:me("{0} files",{0:t.length}):t.name:me("Choose file"),Nr=Re(({id:t,label:e,value:o,values:n,onChange:s,accept:r,multiple:i,disabled:a})=>p`<div class="input input-inline-file" name=${t}>
			...
			/>
		</div>`);export{Nr as A,Ir as B,H as C,ls as D,Nn as E,Pr as F,Lr as G,M as H,ys as I,zt as J,Xe as K,de as L,x as M,Ce as N,yt as O,w as P,Or as a,Gt as b,se as c,Re as d,Yn as e,Un as f,qt as g,S as h,R as i,Tr as j,cs as k,Te as l,ge as m,_ as n,y as o,L as p,bs as q,Wn as r,Mr as s,le as t,Ze as u,ss as v,gt as w,Rt as x,Ut as y,Rr as z};
