import{b as B}from"./iframe-ByytzOm3.js";import{d as D,o as e,l as E,I as F,g as G}from"./inline-file-BjfGQWU_.js";const L=D(({id:m,variant:s,label:c,error:a,required:d,warning:o,suffix:u,mode:l,disabled:h,onChange:g,options:r,limit:n,min:f,textProperty:y,valueProperty:b,value:$,values:p,itemRenderer:x,chipRenderer:k,keepOpened:q,keepQuery:v,placeholder:w,wrap:z,showSingle:C,preserveOrder:P,title:R,textual:H,description:I,externalSearch:M,itemHeight:j,context:i,...A})=>B`<cosmoz-autocomplete
			...
			?external-search=${M}
			>${G({suffix:u,warning:o,description:I})}</cosmoz-autocomplete
		>`);export{L as a};
