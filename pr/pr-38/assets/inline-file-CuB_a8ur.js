...
`;customElements.define("cosmoz-toggle",et(Wi,{styleSheets:[Ji,Yi],observedAttributes:["disabled"]}));const qi=e=>{if(!e||e===1/0)return;if(typeof e=="number")return e;const t=parseFloat(e.replace(/[\s]/gu,"").replace(/^−/gu,"-").replace(/[,.]/gu,".").replace(/[.](?=.*[.])/gu,""));if(!isNaN(t))return t},Gi=/^[0-9.,e-]+$/u,Xi=e=>e==null||e===""||Number.isNaN(e)||Array.isArray(e)&&e.length<1,un=e=>Xi(e)&&Ce("Required"),Qi=Symbol("error"),Zi=(e,t,n,s,i)=>{for(const o of at(e)){const r=o(t,n,s,i);if(r)return r}},to=(e,t,n)=>e.validate&&Zi(e.validate,t[e.path??e.id],t,e,n),eo=(e,t,n)=>{const s=e.map(i=>({...i,error:to(i,t,n)}));return{fields:s,invalid:s.some(({error:i})=>!!i)}},no=(e,t,n)=>t?eo(e,t,n):{fields:e,invalid:!0},so=(e,t,n,s)=>{s!=null&&Object.is(s[t],n)||e({[t]:n})},io=e=>Array.isArray(e)?e.some(t=>t===un):e===un,Un=e=>({field:t,value:n,values:s,onChange:i,context:o,...r})=>{const a=(u,d)=>(t.onChange??so)(h=>i(h,d),t.path??t.id,rn(t.value?.[1],u,s,t,o),s),l=B(t.mandatory??io(t.validate),n,s,t,o)?" *":void 0;if(!B(t.hidden,n,s,t,o))return e({...t,...r,context:o,values:s,label:[B(t.label,n,s,t,o),l].join(""),placeholder:B(t.placeholder,n,s,t,o),disabled:B(t.disabled,n,s,t,o),warning:B(t.warning,n,s,t,o),prefix:B(t.prefix,n,s,t,o),suffix:B(t.suffix,n,s,t,o),value:rn(t.value?.[0],n,s,t,o),onFocus:t.onFocus?.(a,n,s,t),onPaste:t.onPaste?.(a,n,s,t),onChange:a})},oo=e=>F(e,()=>C`<span slot="prefix">${e}</span>`),ro=e=>F(e,()=>C`<span slot="suffix">${e}</span>`),ao=(e,t="suffix")=>F(e,()=>Gs({slot:t,title:e,width:"22",height:"22",styles:"color: var(--paper-amber-500); vertical-align: middle"})),lo=(e,t="suffix")=>F(e,()=>qs({slot:t,title:e,width:"22",height:"22",styles:"color: var(--cz-text-color); vertical-align: middle; cursor: help"})),co=({prefix:e,suffix:t,warning:n,description:s})=>[oo(e),ro(t),ao(n),lo(s)],Kn=e=>{const{value:t,values:n,onFocus:s,onInput:i,onPaste:o,context:r,...a}=e,{id:l,type:c="text",label:u,placeholder:d,noLabelFloat:h,alwaysFloatLabel:f,error:p,prefix:g,suffix:m,warning:b,allowedPattern:v,step:y,disabled:x,maxlength:_,min:E,max:S,autosize:z,noSpinner:T,autocomplete:A,title:M,description:K}=a;return C`<cosmoz-input
		...
		@paste=${o}
		@input=${i}
		>${co({prefix:g,suffix:m,warning:b,description:K})}</cosmoz-input
...
`,Hr=e=>{const t=e==="auto",[n,s]=Y(t?40:e);return[n,i=>t?s(i):void 0]},Mt=e=>{const t=N(()=>({}),[]);return N(()=>Object.assign(t,e),[t,...Object.values(e)])},Ur=e=>{const t=Mt(e);R(()=>{const n=s=>{if(!(s.ctrlKey&&s.altKey||s.defaultPrevented))switch(s.key){case"Up":case"ArrowUp":s.preventDefault(),t.onUp();break;case"Down":case"ArrowDown":s.preventDefault(),t.onDown();break;case"Enter":s.preventDefault(),t.onEnter();break}};return document.addEventListener("keydown",n,!0),()=>document.removeEventListener("keydown",n,!0)},[t])},Kr=({items:e,onSelect:t,defaultIndex:n=0})=>{const[s,i]=Y({index:n}),{index:o}=s,{length:r}=e;return R(()=>{i({index:s.index<0?n:Math.min(s.index,e.length-1),scroll:!0})},[e,n]),Ur({onUp:$(()=>i(a=>({index:a.index>0?a.index-1:r-1,scroll:!0})),[r]),onDown:$(()=>i(a=>({index:a.index<r-1?a.index+1:0,scroll:!0})),[r]),onEnter:$(()=>o>-1&&o<r&&t?.(e[o],o),[o,e,t])}),{position:s,highlight:$(a=>i({index:a}),[]),select:$(a=>t?.(a),[t])}},Wr=(e,t)=>t?n=>at(e).find(s=>s[t]===n[t]):n=>at(e).includes(n),Yr=(e,t)=>{if(!t||!e)return e;const n=e.toLowerCase().indexOf(t.toLowerCase());if(n<0)return e;const s=n+t.length;return[e.slice(0,n),C`<mark>${e.slice(n,s)}</mark>`,e.slice(s)]},Jr=(e=Jt)=>(t,n,{highlight:s,select:i,textual:o=Jt,query:r,isSelected:a})=>{const l=o(t),c=Yr(l,r),u=e(c,t,n);return C`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(t)}
...
</svg>`;export{Un as a,Y as b,et as c,N as d,vt as e,Do as f,fo as g,F as h,Tt as i,kt as j,R as k,ie as l,pn as m,Ra as n,O as o,$ as p,B as q,co as r,Io as s,Kt as t,wt as u,uo as v,Mn as w};
