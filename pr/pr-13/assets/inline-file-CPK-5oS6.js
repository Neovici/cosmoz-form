import{r as Ps,D as Es,A as st,w as li,b as C,E as q,n as zn,M as Mn,u as gt,v as kt,h as Ie,p as Os}from"./iframe-B2Kb3zU0.js";import{_ as Fn}from"./preload-helper-PPVm8Dsz.js";let ue,$s=0;function Si(e){ue=e}function Ci(){ue=null,$s=0}function Dn(){return $s++}const je=Symbol("haunted.phase"),ae=Symbol("haunted.hook"),Pi=Symbol("haunted.update"),Ei=Symbol("haunted.commit"),mt=Symbol("haunted.effects"),It=Symbol("haunted.layoutEffects"),qe="haunted.context";class In{update;host;virtual;[ae];[mt];[It];constructor(t,i){this.update=t,this.host=i,this[ae]=new Map,this[mt]=[],this[It]=[]}run(t){Si(this);let i=t();return Ci(),i}_runEffects(t){let i=this[t];Si(this);for(let s of i)s.call(this);Ci()}runEffects(){this._runEffects(mt)}runLayoutEffects(){this._runEffects(It)}teardown(){this[ae].forEach(i=>{typeof i.teardown=="function"&&i.teardown(!0)})}}const jn=Promise.resolve().then.bind(Promise.resolve());function Ts(){let e=[],t;function i(){t=null;let s=e;e=[];for(var n=0,r=s.length;n<r;n++)s[n]()}return function(s){e.push(s),t==null&&(t=jn(i))}}const Vn=Ts(),Oi=Ts();class Bn{renderer;host;state;[je];_updateQueued;_active;constructor(t,i){this.renderer=t,this.host=i,this.state=new In(this.update.bind(this),i),this[je]=null,this._updateQueued=!1,this._active=!0}update(){this._active&&(this._updateQueued||(Vn(()=>{let t=this.handlePhase(Pi);Oi(()=>{this.handlePhase(Ei,t),Oi(()=>{this.handlePhase(mt)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(t,i){switch(this[je]=t,t){case Ei:this.commit(i),this.runEffects(It);return;case Pi:return this.render();case mt:return this.runEffects(mt)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(t){this.state._runEffects(t)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const ci=(...e)=>{const t=new CSSStyleSheet;return t.replaceSync(e.join("")),t},Hn=e=>e?.map(t=>typeof t=="string"?ci(t):t),Un=(e,...t)=>e.flatMap((i,s)=>[i,t[s]||""]).join(""),bt=Un,Kn=(e="")=>e.replace(/-+([a-z])?/g,(t,i)=>i?i.toUpperCase():"");function Wn(e){class t extends Bn{frag;renderResult;constructor(n,r,o){super(n,o||r),this.frag=r}commit(n){this.renderResult=e(n,this.frag)}}function i(s,n,r){const o=(r||n||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||n||{},d=Hn(s.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return s.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new t(s,this);else{const g=this.attachShadow({mode:"open",...c});d&&(g.adoptedStyleSheets=d),this._scheduler=new t(s,g,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(g,_,y){if(_===y)return;let b=y===""?!0:y;Reflect.set(this,Kn(g),b)}}function f(m){let g=m,_=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return g},set(y){_&&g===y||(_=!0,g=y,this._scheduler&&this._scheduler.update())}})}const p=new Proxy(o.prototype,{getPrototypeOf(m){return m},set(m,g,_,y){let b;return g in m?(b=Object.getOwnPropertyDescriptor(m,g),b&&b.set?(b.set.call(y,_),!0):(Reflect.set(m,g,_,y),!0)):(typeof g=="symbol"||g[0]==="_"?b={enumerable:!0,configurable:!0,writable:!0,value:_}:b=f(_),Object.defineProperty(y,g,b),b.set&&b.set.call(y,_),!0)}});return Object.setPrototypeOf(h.prototype,p),h}return i}class ht{id;state;constructor(t,i){this.id=t,this.state=i}}function Yn(e,...t){let i=Dn(),s=ue[ae],n=s.get(i);return n||(n=new e(i,ue,...t),s.set(i,n)),n.update(...t)}function ft(e){return Yn.bind(null,e)}function Ls(e){return ft(class extends ht{callback;lastValues;values;_teardown;constructor(t,i,s,n){super(t,i),e(i,this)}update(t,i){this.callback=t,this.values=i}call(){const t=!this.values||this.hasChanged();this.lastValues=this.values,t&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(t){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),t&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((t,i)=>this.lastValues[i]!==t)}})}function As(e,t){e[mt].push(t)}const k=Ls(As),Jn=e=>e instanceof Element?e:e.startNode||e.endNode||e.parentNode,qn=ft(class extends ht{Context;value;_ranEffect;_unsubscribe;constructor(e,t,i){super(e,t),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,As(t,this)}update(e){return this.Context!==e&&(this._subscribe(e),this.Context=e),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(e){this.value=e,this.state.update()}_subscribe(e){const t={Context:e,callback:this._updater};Jn(this.state.host).dispatchEvent(new CustomEvent(qe,{detail:t,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:s=null,value:n}=t;this.value=s?n:e.defaultValue,this._unsubscribe=s}teardown(){this._unsubscribe&&this._unsubscribe()}});function Gn(e){return t=>{const i={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(qe,this)}disconnectedCallback(){this.removeEventListener(qe,this)}handleEvent(s){const{detail:n}=s;n.Context===i&&(n.value=this.value,n.unsubscribe=this.unsubscribe.bind(this,n.callback),this.listeners.add(n.callback),s.stopPropagation())}unsubscribe(s){this.listeners.delete(s)}set value(s){this._value=s;for(let n of this.listeners)n(s)}get value(){return this._value}},Consumer:e(function({render:s}){const n=qn(i);return s(n)},{useShadowDOM:!1}),defaultValue:t};return i}}const F=ft(class extends ht{value;values;constructor(e,t,i,s){super(e,t),this.value=i(),this.values=s}update(e,t){return this.hasChanged(t)&&(this.values=t,this.value=e()),this.value}hasChanged(e=[]){return e.some((t,i)=>this.values[i]!==t)}}),E=(e,t)=>F(()=>e,t);function Xn(e,t){e[It].push(t)}const Ge=Ls(Xn),G=ft(class extends ht{args;constructor(e,t,i){super(e,t),this.updater=this.updater.bind(this),typeof i=="function"&&(i=i()),this.makeArgs(i)}update(){return this.args}updater(e){const[t]=this.args;typeof e=="function"&&(e=e(t)),!Object.is(t,e)&&(this.makeArgs(e),this.state.update())}makeArgs(e){this.args=Object.freeze([e,this.updater])}}),Qn=ft(class extends ht{reducer;currentState;constructor(e,t,i,s,n){super(e,t),this.dispatch=this.dispatch.bind(this),this.currentState=n!==void 0?n(s):s}update(e){return this.reducer=e,[this.currentState,this.dispatch]}dispatch(e){this.currentState=this.reducer(this.currentState,e),this.state.update()}}),Zn=/([A-Z])/gu,tr=ft(class extends ht{property;eventName;constructor(e,t,i,s){if(super(e,t),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=i,this.eventName=i.replace(Zn,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof s=="function"&&(s=s()),s!=null&&this.updateProp(s))}update(e,t){return[this.state.host[this.property],this.updater]}updater(e){const t=this.state.host[this.property];typeof e=="function"&&(e=e(t)),!Object.is(t,e)&&this.updateProp(e)}updateProp(e){this.notify(e).defaultPrevented||(this.state.host[this.property]=e)}notify(e){const t=new CustomEvent(this.eventName,{detail:{value:e,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(t),t}});function Ot(e){return F(()=>({current:e}),[])}function er({render:e}){const t=Wn(e),i=Gn(t);return{component:t,createContext:i}}const tt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},xt=e=>(...t)=>({_$litDirective$:e,values:t});let qt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,s){this._$Ct=t,this._$AM=i,this._$Ci=s}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}};const jt=(e,t)=>{const i=e._$AN;if(i===void 0)return!1;for(const s of i)s._$AO?.(t,!1),jt(s,t);return!0},de=e=>{let t,i;do{if((t=e._$AM)===void 0)break;i=t._$AN,i.delete(e),e=t}while(i?.size===0)},Rs=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(i===void 0)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),nr(t)}};function ir(e){this._$AN!==void 0?(de(this),this._$AM=e,Rs(this)):this._$AM=e}function sr(e,t=!1,i=0){const s=this._$AH,n=this._$AN;if(n!==void 0&&n.size!==0)if(t)if(Array.isArray(s))for(let r=i;r<s.length;r++)jt(s[r],!1),de(s[r]);else s!=null&&(jt(s,!1),de(s));else jt(this,e)}const nr=e=>{e.type==tt.CHILD&&(e._$AP??=sr,e._$AQ??=ir)};class ui extends qt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,i,s){super._$AT(t,i,s),Rs(this),this.isConnected=t._$AU}_$AO(t,i=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),i&&(jt(this,t),de(this))}setValue(t){if(Ps(this._$Ct))this._$Ct._$AI(t,this);else{const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0)}}disconnected(){}reconnected(){}}const{component:rt}=er({render:Es});const R=e=>e??st;function D(e,t,i){return e?t(e):i?.(e)}const rr=({slot:e,title:t,className:i,width:s="24",height:n="24",styles:r}={})=>C`
	<svg
		slot=${R(e)}
		class=${`clear-icon ${i??""}`}
		viewBox="0 0 24 24"
...
`,or=({slot:e,title:t,className:i,width:s="24",height:n="24",styles:r}={})=>C`
	<svg
		slot=${R(e)}
...
`,ar=({slot:e,title:t,className:i,width:s="24",height:n="24",styles:r}={})=>C`
	<svg
		slot=${R(e)}
...
`,pt=ft(class extends ht{update(){return this.state.host}}),lt=(e,...t)=>e.flatMap((i,s)=>[i,t[s]??""]).join(""),di=(...e)=>{const t=new CSSStyleSheet;return t.replaceSync(e.join("")),t},lr=lt`
	:host {
		display: flex;
...
`,cr=()=>{const e=pt(),t=E(()=>{e.dispatchEvent(new Event("close")),e.onClose?.()},[]);return k(()=>{const i=o=>{o.preventDefault(),t()},s=e.shadowRoot,n=o=>o.target.value==="cancel"&&i(o),r=o=>!o.defaultPrevented&&o.key==="Escape"&&i(o);return s.addEventListener("click",n),document.addEventListener("keydown",r,!0),()=>{s.removeEventListener("click",n),document.removeEventListener("keydown",r,!0)}},[]),{close:t}},ur=()=>{const e=pt(),{manualFocus:t}=e;Ge(()=>{!t&&!e.matches(":focus-within")&&(e.setAttribute("tabindex","-1"),e.focus(),e.removeAttribute("tabindex"))},[t])},dr=(e,t,i)=>{const s=e.width/3,n=e.height/3,r=Math.min(window.innerWidth-2*s,Math.max(-s,t)),o=Math.min(window.innerHeight-2*n,Math.max(-n,i));return{x:r,y:o}},hr=(e,t,i,s)=>n=>{if(!n.target.closest(t))return;const r=dr,o=e.getBoundingClientRect(),a=n.clientX-o.x,l=n.clientY-o.y,c=(h,f)=>{const p=h-a,m=f-l,g=r(o,p,m);Object.assign(e.style,{left:g.x+"px",top:g.y+"px",transform:"initial"})},u=h=>c(h.clientX,h.clientY),d=h=>{document.removeEventListener("mousemove",u),document.removeEventListener("mouseup",d)};document.addEventListener("mousemove",u),document.addEventListener("mouseup",d)},fr=()=>{const e=pt(),{unmovable:t}=e;k(()=>{if(t)return;const i=e.shadowRoot;if(!i)return;const s=hr(e,".title");return i.addEventListener("mousedown",s),()=>i.removeEventListener("mousedown",s)},[t])},pr=()=>{cr(),fr(),ur()},gr=({title:e,content:t,styles:i,closeable:s=!1})=>{const n=pt();return C`
		<style>
			${lr}${i}
		</style>
	...
	`},hi=(e,{observedAttributes:t,styles:i,...s}={})=>rt(n=>(pr(),gr({title:n.heading||n.title,content:e(n),styles:i,closeable:n.closeable})),{observedAttributes:["title","heading","manual-focus","unmovable","closeable",...t??[]],...s}),mr=bt`
	@keyframes rotating {
		100% {
...
`,_r=()=>st,yr=rt(_r,{styleSheets:[mr]});customElements.define("cosmoz-spinner",yr);customElements.define("cosmoz-dialog-loading",hi(()=>C`
			<style>
				.content {
					flex-direction: row;
					align-items: center;
	...
	`,nn=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],Ra=({placeholder:e,noLabelFloat:t,label:i})=>(t?i:void 0)||e||" ",os=lt`
	.wrap {
...
`,ka=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...nn],Na=e=>{const{type:t="text",pattern:i,allowedPattern:s,autocomplete:n,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=e,{onChange:h,onFocus:f,onInput:p,onRef:m}=en(e),g=Aa(s);return sn(C`
			<input
				${Gt(m)}
				...
				step=${R(u)}
			/>
		`,e)};customElements.define("cosmoz-input",rt(Na,{observedAttributes:ka,styleSheets:[ci(rn)]}));const as=e=>{e.style.height="",e.style.height=`${e.scrollHeight}px`},za=(e,t=0)=>{if(t>0){const i=e.getAttribute("rows")??"",s=e.style.height;e.style.height="",e.setAttribute("rows",t),e.style.maxHeight=e.getBoundingClientRect().height+"px",e.style.height=s,e.setAttribute("rows",i)}},Ma=e=>{const{value:t,maxRows:i}=e,s=F(()=>()=>e.shadowRoot.querySelector("#input"),[]);k(()=>za(s(),i),[i,s]),k(()=>as(s()),[s,t]),k(()=>{const n=s(),r=new ResizeObserver(()=>requestAnimationFrame(()=>as(n)));return r.observe(n),()=>r.unobserve(n)},[s])},Fa=["rows","placeholder",...nn],Da=e=>{const{autocomplete:t,value:i,placeholder:s,readonly:n,disabled:r,rows:o,cols:a,maxlength:l}=e,{onChange:c,onFocus:u,onInput:d,onRef:h}=en(e);return Ma(e),sn(C`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${u} @blur=${u}>`,e)};customElements.define("cosmoz-textarea",rt(Da,{observedAttributes:Fa,styleSheets:[ci(rn)]}));const Ia=e=>{const{label:t,value:i,disabled:s,error:n}=e,r=E(o=>e.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return C`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${D(n,o=>C`<div class="failure">${o}</div>`)} `},ja=bt`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
...
`;customElements.define("cosmoz-toggle",rt(Ia,{styleSheets:[Va,ja],observedAttributes:["disabled"]}));const Ba=e=>e==null||e===""||Number.isNaN(e)||Array.isArray(e)&&e.length<1,ls=e=>Ba(e)&&Yt("Required"),Ha=Symbol("error"),Ua=(e,t,i,s)=>{for(const n of ut(e)){const r=n(t,i,s);if(r)return r}},Ka=(e,t)=>e.validate&&Ua(e.validate,t[e.path??e.id],t,e),Wa=(e,t)=>{const i=e.map(s=>({...s,error:Ka(s,t)}));return{fields:i,invalid:i.some(({error:s})=>!!s)}},Ya=(e,t)=>t?Wa(e,t):{fields:e,invalid:!0},Ja=(e,t,i,s)=>{s!=null&&Object.is(s[t],i)||e({[t]:i})},qa=e=>Array.isArray(e)?e.some(t=>t===ls):e===ls,Ga=e=>({field:t,value:i,values:s,onChange:n,...r})=>{const o=(c,u)=>(t.onChange??Ja)(d=>n(d,u),t.path??t.id,ns(t.value?.[1],c,s,t),s),a=U(t.mandatory??qa(t.validate),i,s,t)?" *":void 0;if(!U(t.hidden,i,s,t))return e({...t,...r,values:s,label:[U(t.label,i,s,t),a].join(""),placeholder:U(t.placeholder,i,s,t),disabled:U(t.disabled,i,s,t),warning:U(t.warning,i,s,t),prefix:U(t.prefix,i,s,t),suffix:U(t.suffix,i,s,t),value:ns(t.value?.[0],i,s,t),onFocus:t.onFocus?.(o,i,s,t),onChange:o})},Xa=e=>D(e,()=>C`<span slot="prefix">${e}</span>`),Qa=e=>D(e,()=>C`<span slot="suffix">${e}</span>`),Za=(e,t="suffix")=>D(e,()=>ar({slot:t,title:e,width:"22",height:"22",styles:"color: var(--paper-amber-500); vertical-align: middle"})),tl=(e,t="suffix")=>D(e,()=>or({slot:t,title:e,width:"22",height:"22",styles:"color: var(--cz-text-color); vertical-align: middle; cursor: help"})),el=({prefix:e,suffix:t,warning:i,description:s})=>[Xa(e),Qa(t),Za(i),tl(s)],il=e=>{const{value:t,values:i,onFocus:s,onInput:n,...r}=e,{id:o,type:a="text",label:l,placeholder:c,noLabelFloat:u,alwaysFloatLabel:d,error:h,prefix:f,suffix:p,warning:m,allowedPattern:g,step:_,disabled:y,maxlength:b,min:v,max:w,autosize:$,noSpinner:S,title:A,description:z}=r;return C`<cosmoz-input
...
`;const _l=()=>st,yl=(e,t)=>Promise.resolve(e).then(t,t),bl=e=>we(e?.then(_l,t=>C`<div class="failure">${t.message}</div>`),st),vl=({save$:e,progress:t,...i})=>{const s=({onSave:n,onClick:r=n,title:o,disabled:a,progress:l,content:c=st,slot:u})=>C` <button
			class="button save"
			slot=${R(u)}
			?disabled=${a}
			?data-progress=${l}
		...
		>
			${c} ${o}
		</button>`;return we(yl(e,()=>s(i)),s({...i,disabled:!0,progress:!0,content:C`<cz-spinner></cz-spinner> ${D(t,n=>n.join("/"))}`}))},wl=lt`
	.button {
		font-family: inherit;
	}
...
`,xl=(e,t)=>new Promise((i,s)=>{if(t.aborted){s(new DOMException("Aborted","AbortError"));return}const n=setTimeout(i,e);t.addEventListener("abort",()=>{clearTimeout(n),s(new DOMException("Aborted","AbortError"))},{once:!0})});async function Sl(e,t,i,s){let n;for(;;){if(t.aborted)return await e.return({}),null;const{value:r,done:o}=await e.next(n);if(o)return r;switch(r._tag){case"loading":i(r.patch),n=void 0;break;case"call":n=await r.fn(t,...r.args);break;case"delay":try{await xl(r.ms,t)}catch(a){if(a instanceof DOMException&&a.name==="AbortError")return await e.return({}),null;throw a}n=void 0;break;case"select":n=r.selector?r.selector(s()):s();break}if(t.aborted)return await e.return({}),null}}const Cl=()=>{let e=null;return{run:async(t,i,s)=>{e?.abort(),e=new AbortController;try{return await Sl(t,e.signal,i,s)}catch(n){if(n instanceof DOMException&&n.name==="AbortError")return null;throw n}},cancel:()=>{e?.abort(),e=null}}},Pl=(e,t)=>e.length!==t.length||e.some((i,s)=>!Object.is(i,t[s])),El=e=>{console.error("[cosmoz-form] async rule error:",e)},Ol=(e,t,i)=>{const s=El,n=Ot(e.values);n.current=e.values;const r=Ot(new Map),o=Ot(new Map),a=Ot(new Map);return k(()=>()=>{for(const l of r.current.values())l.cancel()},[]),k(()=>{if(t?.length)for(const l of t){const[c,u,d=Cl]=l;r.current.has(l)||r.current.set(l,d());const h=u(e.values),f=o.current.get(l);if(f!=null&&!Pl(h,f))continue;const p=a.current.get(l);o.current.set(l,h),a.current.set(l,e.values),r.current.get(l).run(c(e.values,p,void 0,void 0),g=>e.onChange(g,!1),()=>n.current).then(g=>{g!==null&&e.onChange(g,!1)}).catch(g=>s(g,l))}},[e.values]),e},$l=(e,t)=>!t||e.some((i,s)=>!Object.is(t[s],i)),ce=({oldItem:e,newItem:t,rules:i,index:s,oldIndex:n=s})=>i?i.reduce((r,[o,a])=>e&&a&&!$l(a(r,s),a(e,n))?r:{...r,...o(r,e,s,n)},t):t,Tl=(e,t,i)=>{const[,s]=e;return{values:s,onReset:E(()=>t(([n])=>[n,n]),[t]),onValues:E((n,r=!0)=>t(([o,a])=>[o,ni(ce({oldItem:a,newItem:U(n,a),rules:i}),r)]),[i,t]),onChange:E((n,r=!0)=>t(([o,a])=>[o,ni(ce({oldItem:a,newItem:{...a,...U(n,a)},rules:i}),r)]),[i,t]),load:E((n,r)=>{if(!n){t([n,n]);return}const o=on(ce({oldItem:void 0,newItem:n,rules:r??i}));t([o,o])},[i,t]),touched:F(()=>an(s),[s])}},Ll=(e,t)=>on(ce({oldItem:void 0,newItem:e,rules:t})),ln=(e,t=[])=>{const i=e.filter(s=>s?.rules!=null).flatMap(s=>s?.rules);return[...t,...i]},Al=(e,t,{fields:i,rules:s})=>{const n=F(()=>U(i)??[],[i]),r=F(()=>ln(n,s),[n,s]),o=Tl(e,t,r),{values:a}=o;return{...F(()=>Ya(n,a),[n,a]),...o}},Rl=e=>{const[t,i]=G(()=>{const s=U(e.fields)??[],n=ln(s,e.rules),r=Ll(e.initial,n);return[r,r]});return Al(t,i,e)};function kl({fields:e,initial:t,rules:i,asyncRules:s,onSave:n,allowEmpty:r}){const o=Rl({fields:e,initial:t,rules:i});Ol(o,s);const{values:a,invalid:l}=o,[c,u]=G(),[d,h]=G(),f=a==null||a===t,p=o.fields?.length>0&&!(f&&r)&&(f||l);return{...o,save$:c,onSave:E(()=>u(n?.(a,t,h)),[n,a,t]),disabled:p,progress:d}}const Nl=lt`
	.description {
		padding: 0 24px;
	}
	.description * {
...
`,cn=e=>{const{description:t,auto:i,uncancelable:s,hideCancelButton:n,saveText:r=Yt("OK")}=e,{onSave:o,disabled:a,save$:l,progress:c,...u}=kl(e);return k(()=>{i&&o()},[i]),C` <style>
			${wl} ${ol(u)}${Nl}
		</style>
		${D(t,()=>C`<p class="description">${t}</p>`)}
		<div class="form" part="form">${rl(u)}</div>
		<div class="buttons">
			${bl(l)}
			${vl({save$:l,onSave:o,disabled:a,title:r,progress:c})}
			${D(!n,()=>C`<button class="button" value="cancel" ?disabled=${s}>
						${Yt("Cancel")}
					</button>`)}
		</div>`};customElements.define("cosmoz-form-dialog",hi(cn,{observedAttributes:["allow-empty"]}));customElements.define("cosmoz-form-dialog-next",hi(cn,{observedAttributes:["allow-empty"]}));const Lt=Math.min,W=Math.max,xe=Math.round,oe=Math.floor,it=e=>({x:e,y:e}),zl={left:"right",right:"left",bottom:"top",top:"bottom"},Ml={start:"end",end:"start"};function hs(e,t,i){return W(e,Lt(t,i))}function ke(e,t){return typeof e=="function"?e(t):e}function vt(e){return e.split("-")[0]}function Ne(e){return e.split("-")[1]}function un(e){return e==="x"?"y":"x"}function dn(e){return e==="y"?"height":"width"}const Fl=new Set(["top","bottom"]);function ct(e){return Fl.has(vt(e))?"y":"x"}function hn(e){return un(ct(e))}function Dl(e,t,i){i===void 0&&(i=!1);const s=Ne(e),n=hn(e),r=dn(n);let o=n==="x"?s===(i?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=Se(o)),[o,Se(o)]}function Il(e){const t=Se(e);return[oi(e),t,oi(t)]}function oi(e){return e.replace(/start|end/g,t=>Ml[t])}const fs=["left","right"],ps=["right","left"],jl=["top","bottom"],Vl=["bottom","top"];function Bl(e,t,i){switch(e){case"top":case"bottom":return i?t?ps:fs:t?fs:ps;case"left":case"right":return t?jl:Vl;default:return[]}}function Hl(e,t,i,s){const n=Ne(e);let r=Bl(vt(e),i==="start",s);return n&&(r=r.map(o=>o+"-"+n),t&&(r=r.concat(r.map(oi)))),r}function Se(e){return e.replace(/left|right|bottom|top/g,t=>zl[t])}function Ul(e){return{top:0,right:0,bottom:0,left:0,...e}}function Kl(e){return typeof e!="number"?Ul(e):{top:e,right:e,bottom:e,left:e}}function Ce(e){const{x:t,y:i,width:s,height:n}=e;return{width:s,height:n,top:i,left:t,right:t+s,bottom:i+n,x:t,y:i}}function gs(e,t,i){let{reference:s,floating:n}=e;const r=ct(t),o=hn(t),a=dn(o),l=vt(t),c=r==="y",u=s.x+s.width/2-n.width/2,d=s.y+s.height/2-n.height/2,h=s[a]/2-n[a]/2;let f;switch(l){case"top":f={x:u,y:s.y-n.height};break;case"bottom":f={x:u,y:s.y+s.height};break;case"right":f={x:s.x+s.width,y:d};break;case"left":f={x:s.x-n.width,y:d};break;default:f={x:s.x,y:s.y}}switch(Ne(t)){case"start":f[o]-=h*(i&&c?-1:1);break;case"end":f[o]+=h*(i&&c?-1:1);break}return f}const Wl=async(e,t,i)=>{const{placement:s="bottom",strategy:n="absolute",middleware:r=[],platform:o}=i,a=r.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:e,floating:t,strategy:n}),{x:u,y:d}=gs(c,s,l),h=s,f={},p=0;for(let m=0;m<a.length;m++){const{name:g,fn:_}=a[m],{x:y,y:b,data:v,reset:w}=await _({x:u,y:d,initialPlacement:s,placement:h,strategy:n,middlewareData:f,rects:c,platform:o,elements:{reference:e,floating:t}});u=y??u,d=b??d,f={...f,[g]:{...f[g],...v}},w&&p<=50&&(p++,typeof w=="object"&&(w.placement&&(h=w.placement),w.rects&&(c=w.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:n}):w.rects),{x:u,y:d}=gs(c,h,l)),m=-1)}return{x:u,y:d,placement:h,strategy:n,middlewareData:f}};async function _i(e,t){var i;t===void 0&&(t={});const{x:s,y:n,platform:r,rects:o,elements:a,strategy:l}=e,{boundary:c="clippingAncestors",rootBoundary:u="viewport",elementContext:d="floating",altBoundary:h=!1,padding:f=0}=ke(t,e),p=Kl(f),g=a[h?d==="floating"?"reference":"floating":d],_=Ce(await r.getClippingRect({element:(i=await(r.isElement==null?void 0:r.isElement(g)))==null||i?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:u,strategy:l})),y=d==="floating"?{x:s,y:n,width:o.floating.width,height:o.floating.height}:o.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),v=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},w=Ce(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:y,offsetParent:b,strategy:l}):y);return{top:(_.top-w.top+p.top)/v.y,bottom:(w.bottom-_.bottom+p.bottom)/v.y,left:(_.left-w.left+p.left)/v.x,right:(w.right-_.right+p.right)/v.x}}const Yl=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,s;const{placement:n,middlewareData:r,rects:o,initialPlacement:a,platform:l,elements:c}=t,{mainAxis:u=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:f="bestFit",fallbackAxisSideDirection:p="none",flipAlignment:m=!0,...g}=ke(e,t);if((i=r.arrow)!=null&&i.alignmentOffset)return{};const _=vt(n),y=ct(a),b=vt(a)===a,v=await(l.isRTL==null?void 0:l.isRTL(c.floating)),w=h||(b||!m?[Se(a)]:Il(a)),$=p!=="none";!h&&$&&w.push(...Hl(a,m,p,v));const S=[a,...w],A=await _i(t,g),z=[];let M=((s=r.flip)==null?void 0:s.overflows)||[];if(u&&z.push(A[_]),d){const N=Dl(n,o,v);z.push(A[N[0]],A[N[1]])}if(M=[...M,{placement:n,overflows:z}],!z.every(N=>N<=0)){var V,Z;const N=(((V=r.flip)==null?void 0:V.index)||0)+1,I=S[N];if(I&&(!(d==="alignment"?y!==ct(I):!1)||M.every(T=>ct(T.placement)===y?T.overflows[0]>0:!0)))return{data:{index:N,overflows:M},reset:{placement:I}};let J=(Z=M.filter(L=>L.overflows[0]<=0).sort((L,T)=>L.overflows[1]-T.overflows[1])[0])==null?void 0:Z.placement;if(!J)switch(f){case"bestFit":{var B;const L=(B=M.filter(T=>{if($){const j=ct(T.placement);return j===y||j==="y"}return!0}).map(T=>[T.placement,T.overflows.filter(j=>j>0).reduce((j,at)=>j+at,0)]).sort((T,j)=>T[1]-j[1])[0])==null?void 0:B[0];L&&(J=L);break}case"initialPlacement":J=a;break}if(n!==J)return{reset:{placement:J}}}return{}}}},Jl=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:s,placement:n}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:a={fn:g=>{let{x:_,y}=g;return{x:_,y}}},...l}=ke(e,t),c={x:i,y:s},u=await _i(t,l),d=ct(vt(n)),h=un(d);let f=c[h],p=c[d];if(r){const g=h==="y"?"top":"left",_=h==="y"?"bottom":"right",y=f+u[g],b=f-u[_];f=hs(y,f,b)}if(o){const g=d==="y"?"top":"left",_=d==="y"?"bottom":"right",y=p+u[g],b=p-u[_];p=hs(y,p,b)}const m=a.fn({...t,[h]:f,[d]:p});return{...m,data:{x:m.x-i,y:m.y-s,enabled:{[h]:r,[d]:o}}}}}},ql=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var i,s;const{placement:n,rects:r,platform:o,elements:a}=t,{apply:l=()=>{},...c}=ke(e,t),u=await _i(t,c),d=vt(n),h=Ne(n),f=ct(n)==="y",{width:p,height:m}=r.floating;let g,_;d==="top"||d==="bottom"?(g=d,_=h===(await(o.isRTL==null?void 0:o.isRTL(a.floating))?"start":"end")?"left":"right"):(_=d,g=h==="end"?"top":"bottom");const y=m-u.top-u.bottom,b=p-u.left-u.right,v=Lt(m-u[g],y),w=Lt(p-u[_],b),$=!t.middlewareData.shift;let S=v,A=w;if((i=t.middlewareData.shift)!=null&&i.enabled.x&&(A=b),(s=t.middlewareData.shift)!=null&&s.enabled.y&&(S=y),$&&!h){const M=W(u.left,0),V=W(u.right,0),Z=W(u.top,0),B=W(u.bottom,0);f?A=p-2*(M!==0||V!==0?M+V:W(u.left,u.right)):S=m-2*(Z!==0||B!==0?Z+B:W(u.top,u.bottom))}await l({...t,availableWidth:A,availableHeight:S});const z=await o.getDimensions(a.floating);return p!==z.width||m!==z.height?{reset:{rects:!0}}:{}}}};function ze(){return typeof window<"u"}function Rt(e){return fn(e)?(e.nodeName||"").toLowerCase():"#document"}function Y(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function ot(e){var t;return(t=(fn(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function fn(e){return ze()?e instanceof Node||e instanceof Y(e).Node:!1}function X(e){return ze()?e instanceof Element||e instanceof Y(e).Element:!1}function nt(e){return ze()?e instanceof HTMLElement||e instanceof Y(e).HTMLElement:!1}function ms(e){return!ze()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof Y(e).ShadowRoot}const Gl=new Set(["inline","contents"]);function Xt(e){const{overflow:t,overflowX:i,overflowY:s,display:n}=Q(e);return/auto|scroll|overlay|hidden|clip/.test(t+s+i)&&!Gl.has(n)}const Xl=new Set(["table","td","th"]);function Ql(e){return Xl.has(Rt(e))}const Zl=[":popover-open",":modal"];function Me(e){return Zl.some(t=>{try{return e.matches(t)}catch{return!1}})}const tc=["transform","translate","scale","rotate","perspective"],ec=["transform","translate","scale","rotate","perspective","filter"],ic=["paint","layout","strict","content"];function yi(e){const t=bi(),i=X(e)?Q(e):e;return tc.some(s=>i[s]?i[s]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||ec.some(s=>(i.willChange||"").includes(s))||ic.some(s=>(i.contain||"").includes(s))}function sc(e){let t=dt(e);for(;nt(t)&&!At(t);){if(yi(t))return t;if(Me(t))return null;t=dt(t)}return null}function bi(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const nc=new Set(["html","body","#document"]);function At(e){return nc.has(Rt(e))}function Q(e){return Y(e).getComputedStyle(e)}function Fe(e){return X(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function dt(e){if(Rt(e)==="html")return e;const t=e.assignedSlot||e.parentNode||ms(e)&&e.host||ot(e);return ms(t)?t.host:t}function pn(e){const t=dt(e);return At(t)?e.ownerDocument?e.ownerDocument.body:e.body:nt(t)&&Xt(t)?t:pn(t)}function Jt(e,t,i){var s;t===void 0&&(t=[]),i===void 0&&(i=!0);const n=pn(e),r=n===((s=e.ownerDocument)==null?void 0:s.body),o=Y(n);if(r){const a=ai(o);return t.concat(o,o.visualViewport||[],Xt(n)?n:[],a&&i?Jt(a):[])}return t.concat(n,Jt(n,[],i))}function ai(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function gn(e){const t=Q(e);let i=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const n=nt(e),r=n?e.offsetWidth:i,o=n?e.offsetHeight:s,a=xe(i)!==r||xe(s)!==o;return a&&(i=r,s=o),{width:i,height:s,$:a}}function vi(e){return X(e)?e:e.contextElement}function Tt(e){const t=vi(e);if(!nt(t))return it(1);const i=t.getBoundingClientRect(),{width:s,height:n,$:r}=gn(t);let o=(r?xe(i.width):i.width)/s,a=(r?xe(i.height):i.height)/n;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const rc=it(0);function mn(e){const t=Y(e);return!bi()||!t.visualViewport?rc:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function oc(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==Y(e)?!1:t}function wt(e,t,i,s){t===void 0&&(t=!1),i===void 0&&(i=!1);const n=e.getBoundingClientRect(),r=vi(e);let o=it(1);t&&(s?X(s)&&(o=Tt(s)):o=Tt(e));const a=oc(r,i,s)?mn(r):it(0);let l=(n.left+a.x)/o.x,c=(n.top+a.y)/o.y,u=n.width/o.x,d=n.height/o.y;if(r){const h=Y(r),f=s&&X(s)?Y(s):s;let p=h,m=ai(p);for(;m&&s&&f!==p;){const g=Tt(m),_=m.getBoundingClientRect(),y=Q(m),b=_.left+(m.clientLeft+parseFloat(y.paddingLeft))*g.x,v=_.top+(m.clientTop+parseFloat(y.paddingTop))*g.y;l*=g.x,c*=g.y,u*=g.x,d*=g.y,l+=b,c+=v,p=Y(m),m=ai(p)}}return Ce({width:u,height:d,x:l,y:c})}function De(e,t){const i=Fe(e).scrollLeft;return t?t.left+i:wt(ot(e)).left+i}function _n(e,t){const i=e.getBoundingClientRect(),s=i.left+t.scrollLeft-De(e,i),n=i.top+t.scrollTop;return{x:s,y:n}}function ac(e){let{elements:t,rect:i,offsetParent:s,strategy:n}=e;const r=n==="fixed",o=ot(s),a=t?Me(t.floating):!1;if(s===o||a&&r)return i;let l={scrollLeft:0,scrollTop:0},c=it(1);const u=it(0),d=nt(s);if((d||!d&&!r)&&((Rt(s)!=="body"||Xt(o))&&(l=Fe(s)),nt(s))){const f=wt(s);c=Tt(s),u.x=f.x+s.clientLeft,u.y=f.y+s.clientTop}const h=o&&!d&&!r?_n(o,l):it(0);return{width:i.width*c.x,height:i.height*c.y,x:i.x*c.x-l.scrollLeft*c.x+u.x+h.x,y:i.y*c.y-l.scrollTop*c.y+u.y+h.y}}function lc(e){return Array.from(e.getClientRects())}function cc(e){const t=ot(e),i=Fe(e),s=e.ownerDocument.body,n=W(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),r=W(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let o=-i.scrollLeft+De(e);const a=-i.scrollTop;return Q(s).direction==="rtl"&&(o+=W(t.clientWidth,s.clientWidth)-n),{width:n,height:r,x:o,y:a}}const _s=25;function uc(e,t){const i=Y(e),s=ot(e),n=i.visualViewport;let r=s.clientWidth,o=s.clientHeight,a=0,l=0;if(n){r=n.width,o=n.height;const u=bi();(!u||u&&t==="fixed")&&(a=n.offsetLeft,l=n.offsetTop)}const c=De(s);if(c<=0){const u=s.ownerDocument,d=u.body,h=getComputedStyle(d),f=u.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,p=Math.abs(s.clientWidth-d.clientWidth-f);p<=_s&&(r-=p)}else c<=_s&&(r+=c);return{width:r,height:o,x:a,y:l}}const dc=new Set(["absolute","fixed"]);function hc(e,t){const i=wt(e,!0,t==="fixed"),s=i.top+e.clientTop,n=i.left+e.clientLeft,r=nt(e)?Tt(e):it(1),o=e.clientWidth*r.x,a=e.clientHeight*r.y,l=n*r.x,c=s*r.y;return{width:o,height:a,x:l,y:c}}function ys(e,t,i){let s;if(t==="viewport")s=uc(e,i);else if(t==="document")s=cc(ot(e));else if(X(t))s=hc(t,i);else{const n=mn(e);s={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Ce(s)}function yn(e,t){const i=dt(e);return i===t||!X(i)||At(i)?!1:Q(i).position==="fixed"||yn(i,t)}function fc(e,t){const i=t.get(e);if(i)return i;let s=Jt(e,[],!1).filter(a=>X(a)&&Rt(a)!=="body"),n=null;const r=Q(e).position==="fixed";let o=r?dt(e):e;for(;X(o)&&!At(o);){const a=Q(o),l=yi(o);!l&&a.position==="fixed"&&(n=null),(r?!l&&!n:!l&&a.position==="static"&&!!n&&dc.has(n.position)||Xt(o)&&!l&&yn(e,o))?s=s.filter(u=>u!==o):n=a,o=dt(o)}return t.set(e,s),s}function pc(e){let{element:t,boundary:i,rootBoundary:s,strategy:n}=e;const o=[...i==="clippingAncestors"?Me(t)?[]:fc(t,this._c):[].concat(i),s],a=o[0],l=o.reduce((c,u)=>{const d=ys(t,u,n);return c.top=W(d.top,c.top),c.right=Lt(d.right,c.right),c.bottom=Lt(d.bottom,c.bottom),c.left=W(d.left,c.left),c},ys(t,a,n));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function gc(e){const{width:t,height:i}=gn(e);return{width:t,height:i}}function mc(e,t,i){const s=nt(t),n=ot(t),r=i==="fixed",o=wt(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const l=it(0);function c(){l.x=De(n)}if(s||!s&&!r)if((Rt(t)!=="body"||Xt(n))&&(a=Fe(t)),s){const f=wt(t,!0,r,t);l.x=f.x+t.clientLeft,l.y=f.y+t.clientTop}else n&&c();r&&!s&&n&&c();const u=n&&!s&&!r?_n(n,a):it(0),d=o.left+a.scrollLeft-l.x-u.x,h=o.top+a.scrollTop-l.y-u.y;return{x:d,y:h,width:o.width,height:o.height}}function Je(e){return Q(e).position==="static"}function bs(e,t){if(!nt(e)||Q(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return ot(e)===i&&(i=i.ownerDocument.body),i}function bn(e,t){const i=Y(e);if(Me(e))return i;if(!nt(e)){let n=dt(e);for(;n&&!At(n);){if(X(n)&&!Je(n))return n;n=dt(n)}return i}let s=bs(e,t);for(;s&&Ql(s)&&Je(s);)s=bs(s,t);return s&&At(s)&&Je(s)&&!yi(s)?i:s||sc(e)||i}const _c=async function(e){const t=this.getOffsetParent||bn,i=this.getDimensions,s=await i(e.floating);return{reference:mc(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}};function yc(e){return Q(e).direction==="rtl"}const bc={convertOffsetParentRelativeRectToViewportRelativeRect:ac,getDocumentElement:ot,getClippingRect:pc,getOffsetParent:bn,getElementRects:_c,getClientRects:lc,getDimensions:gc,getScale:Tt,isElement:X,isRTL:yc};function vn(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function vc(e,t){let i=null,s;const n=ot(e);function r(){var a;clearTimeout(s),(a=i)==null||a.disconnect(),i=null}function o(a,l){a===void 0&&(a=!1),l===void 0&&(l=1),r();const c=e.getBoundingClientRect(),{left:u,top:d,width:h,height:f}=c;if(a||t(),!h||!f)return;const p=oe(d),m=oe(n.clientWidth-(u+h)),g=oe(n.clientHeight-(d+f)),_=oe(u),b={rootMargin:-p+"px "+-m+"px "+-g+"px "+-_+"px",threshold:W(0,Lt(1,l))||1};let v=!0;function w($){const S=$[0].intersectionRatio;if(S!==l){if(!v)return o();S?o(!1,S):s=setTimeout(()=>{o(!1,1e-7)},1e3)}S===1&&!vn(c,e.getBoundingClientRect())&&o(),v=!1}try{i=new IntersectionObserver(w,{...b,root:n.ownerDocument})}catch{i=new IntersectionObserver(w,b)}i.observe(e)}return o(!0),r}function wc(e,t,i,s){s===void 0&&(s={});const{ancestorScroll:n=!0,ancestorResize:r=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:a=typeof IntersectionObserver=="function",animationFrame:l=!1}=s,c=vi(e),u=n||r?[...c?Jt(c):[],...Jt(t)]:[];u.forEach(_=>{n&&_.addEventListener("scroll",i,{passive:!0}),r&&_.addEventListener("resize",i)});const d=c&&a?vc(c,i):null;let h=-1,f=null;o&&(f=new ResizeObserver(_=>{let[y]=_;y&&y.target===c&&f&&(f.unobserve(t),cancelAnimationFrame(h),h=requestAnimationFrame(()=>{var b;(b=f)==null||b.observe(t)})),i()}),c&&!l&&f.observe(c),f.observe(t));let p,m=l?wt(e):null;l&&g();function g(){const _=wt(e);m&&!vn(m,_)&&i(),m=_,p=requestAnimationFrame(g)}return i(),()=>{var _;u.forEach(y=>{n&&y.removeEventListener("scroll",i),r&&y.removeEventListener("resize",i)}),d?.(),(_=f)==null||_.disconnect(),f=null,l&&cancelAnimationFrame(p)}}const xc=Jl,Sc=Yl,Cc=ql,Pc=(e,t,i)=>{const s=new Map,n={platform:bc,...i},r={...n.platform,_c:s};return Wl(e,t,{...n,platform:r})},wn=[Sc({fallbackAxisSideDirection:"start",crossAxis:!1}),xc()],Ec=({placement:e="bottom-start",strategy:t,middleware:i=wn}={})=>{const[s,n]=G(),[r,o]=G(),[a,l]=G();return k(()=>{if(!s||!(r instanceof HTMLElement)){l(void 0);return}return wc(s,r,()=>Pc(s,r,{placement:e,strategy:t,middleware:i}).then(l))},[s,r,e,t,i]),{setReference:n,setFloating:o,styles:F(()=>a?{left:`${a.x}px`,top:`${a.y}px`}:{},[a?.x,a?.y])}},Oc=(e=HTMLElement)=>class extends e{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},$c=(e,t)=>{if(!e||!t)return;const i=Object.keys(t);return Object.fromEntries(Object.keys(e).flatMap(s=>i.includes(s)?[]:[[s,void 0]]))};class Tc extends qt{_props;render(t){return q}update(t,[i]){return this._props!==i&&Object.assign(t.element,$c(this._props,i),this._props=i),q}}const Lc=xt(Tc),Ac=e=>{const t=pt(),i=F(()=>new CSSStyleSheet,[]);k(()=>{t.shadowRoot.adoptedStyleSheets=[...t.shadowRoot.adoptedStyleSheets,i]},[]),k(()=>{i.replaceSync(e)},[e])};const xn="important",Rc=" !"+xn,kc=xt(class extends qt{constructor(e){if(super(e),e.type!==tt.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return s==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const s of this.ft)t[s]==null&&(this.ft.delete(s),s.includes("-")?i.removeProperty(s):i[s]=null);for(const s in t){const n=t[s];if(n!=null){this.ft.add(s);const r=typeof n=="string"&&n.endsWith(Rc);s.includes("-")||r?i.setProperty(s,r?n.slice(0,-11):n,r?xn:""):i[s]=n}}return q}}),Nc="data:image/svg+xml,%3Csvg width='11' height='8' viewBox='0 0 11 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M9.5 1L5.20039 7.04766L1.66348 3.46152' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",zc=bt`
	:host {
		position: fixed;
		z-index: 1000;
...
`,Mc=({index:e,itemHeight:t,auto:i})=>bt`
	${D(!i,()=>bt`
			.item {
				line-height: ${t}px;
				height: ${t}px;
...
`,Fc=e=>{const t=e==="auto",[i,s]=G(t?40:e);return[i,n=>t?s(n):void 0]},Qt=e=>{const t=F(()=>({}),[]);return F(()=>Object.assign(t,e),[t,...Object.values(e)])},Dc=e=>{const t=Qt(e);k(()=>{const i=s=>{if(!(s.ctrlKey&&s.altKey||s.defaultPrevented))switch(s.key){case"Up":case"ArrowUp":s.preventDefault(),t.onUp();break;case"Down":case"ArrowDown":s.preventDefault(),t.onDown();break;case"Enter":s.preventDefault(),t.onEnter();break}};return document.addEventListener("keydown",i,!0),()=>document.removeEventListener("keydown",i,!0)},[t])},Ic=({items:e,onSelect:t,defaultIndex:i=0})=>{const[s,n]=G({index:i}),{index:r}=s,{length:o}=e;return k(()=>{n({index:s.index<0?i:Math.min(s.index,e.length-1),scroll:!0})},[e,i]),Dc({onUp:E(()=>n(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:E(()=>n(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:E(()=>r>-1&&r<o&&t?.(e[r],r),[r,e,t])}),{position:s,highlight:E(a=>n({index:a}),[]),select:E(a=>t?.(a),[t])}},jc=(e,t)=>t?i=>ut(e).find(s=>s[t]===i[t]):i=>ut(e).includes(i),Vc=(e,t)=>{if(!t||!e)return e;const i=e.toLowerCase().indexOf(t.toLowerCase());if(i<0)return e;const s=i+t.length;return[e.slice(0,i),C`<mark>${e.slice(i,s)}</mark>`,e.slice(s)]},Bc=(e=ve)=>(t,i,{highlight:s,select:n,textual:r=ve,query:o,isSelected:a})=>{const l=r(t),c=Vc(l,o),u=e(c,t,i);return C`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(t)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},Hc=({itemRenderer:e=Bc(),...t})=>{const i=Qt(t);return E((s,n)=>e(s,n,i),[i,e])},Uc=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],Kc=({value:e,valueProperty:t,items:i,onSelect:s,defaultIndex:n,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=F(()=>jc(e,t),[e,t]),d=F(()=>i.slice(),[i,u]),{position:h,highlight:f,select:p}=Ic({items:d,onSelect:s,defaultIndex:isNaN(n)?void 0:Number(n)}),[m,g]=Fc(l);return{position:h,items:d,height:Math.min(c,d.length)*m,highlight:f,select:p,itemHeight:m,setItemHeight:g,renderItem:Hc({itemRenderer:a,items:d,position:h,highlight:f,select:p,textual:o,query:r,isSelected:u})}},vs=Sa,Wc=e=>{const t=Ot(void 0),{position:i,items:s,renderItem:n,height:r,itemHeight:o,setItemHeight:a}=Kc(e);return k(()=>{const l=t.current?.[ri];l&&l.layoutComplete.then(()=>{e.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},vs)},[s]),k(()=>{if(!i.scroll)return;const l=t.current?.[ri];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(i.index)?.scrollIntoView({block:"nearest"}),vs);return}l.element(i.index)?.scrollIntoView({block:"nearest"})}},[i]),Ac(Mc({...i,itemHeight:o,auto:e.itemHeight==="auto"})),C`<div
			class="items"
			style="min-height: ${r}px"
			${Gt(l=>t.current=l)}
		>
			<div virtualizer-sizer></div>
			${ml({items:s,renderItem:n,scroller:!0})}
		</div>
		<slot></slot>`};customElements.define("cosmoz-listbox",Oc(rt(Wc,{styleSheets:[di(zc)]})));const Yc=({multi:e,setFloating:t,styles:i,...s},n)=>C`<cosmoz-listbox
		style="${kc(i)}"
...
`;customElements.define("cosmoz-autocomplete-chip",rt(Gc,{observedAttributes:["disabled"],styleSheets:[di(Jc)]}));const Xc=({content:e,onClear:t,disabled:i,hidden:s,className:n="chip",slot:r})=>C`<cosmoz-autocomplete-chip
		class=${R(n)}
		slot=${R(r)}
		part="chip"
	...
	>`,Qc=({value:e,min:t=0,onDeselect:i,textual:s,disabled:n,chipRenderer:r=Xc})=>[...e.filter(Boolean).map(o=>r({item:o,content:s(o),onClear:e.length>t&&(()=>i(o)),disabled:n,slot:"control"})),r({item:null,content:C`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],Zc=bt`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",rt(()=>st,{styleSheets:[Zc]}));const tu=lt`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,ws=e=>e.matches(":focus-within"),eu=({disabled:e,onFocus:t})=>{const[i,s]=G(),{focused:n,closed:r}=i||{},o=n&&!e,a=Qt({closed:r,onFocus:t}),l=E(u=>s(d=>({...d,closed:u})),[]),c=E(u=>{const d=u.currentTarget;return ws(d)?s(h=>({focused:!0,closed:!h?.closed})):d.focus()},[]);return k(()=>{if(!o)return;const u=d=>{if(d.defaultPrevented)return;const{closed:h}=a;d.key==="Escape"&&!h?(d.preventDefault(),l(!0)):["ArrowUp","Up"].includes(d.key)&&h&&(d.preventDefault(),l(!1))};return document.addEventListener("keydown",u,!0),()=>document.removeEventListener("keydown",u,!0)},[o]),{focused:o,active:o&&!r,setClosed:l,onToggle:c,onFocus:E(u=>{const d=ws(u.currentTarget);s({focused:d}),a.onFocus?.(d)},[a])}},wi=(e,t=()=>({}))=>{const i={type:e,toString(){return e}};return Object.assign((...n)=>Object.assign(t(...n),i),i)},xs=e=>e.type||e.toString(),Ss=e=>Array.isArray(e)?e:[e],iu=(e,t)=>{const i=Ss(t),s=(i.every(Array.isArray)?i:[i]).map(([n,r])=>({actions:Ss(n).map(xs),handle:r}));return(n=e,r)=>{const o=s.find(a=>a.actions.includes(xs(r)));return o?o.handle(n,r):n}},yt={pending:"pending",rejected:"rejected",resolved:"resolved"},Sn={error:void 0,result:void 0,state:yt.pending},Cn=wi(yt.pending),Pn=wi(yt.resolved,e=>({result:e})),En=wi(yt.rejected,e=>({error:e})),su=iu(Sn,[[Cn,()=>({error:void 0,result:void 0,state:yt.pending})],[Pn,(e,{result:t})=>({error:void 0,result:t,state:yt.resolved})],[En,(e,{error:t})=>({error:t,result:void 0,state:yt.rejected})]]),nu=e=>{const[{error:t,result:i,state:s},n]=Qn(su,Sn);return k(()=>{if(!e)return;let r=!1;return n(Cn()),e.then(o=>!r&&n(Pn(o)),o=>!r&&n(En(o))),()=>{r=!0}},[e]),[i,t,s]},ru=({focused:e,empty:t,...i})=>{const s=e&&t&&i.limit!==1,n=Qt(i);k(()=>{if(!s)return;const r=o=>{if(o.defaultPrevented)return;const{key:a}=o,l=ut(n.value),c=n.limit==1;if(l.length>0&&(a==="Backspace"||c&&a.length===1))return n.onChange(l.slice(0,-1))};return document.addEventListener("keydown",r,!0),()=>document.removeEventListener("keydown",r,!0)},[s,n])},Cs=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),ou=(e,t,i)=>{if(!t)return e;const s=Cs(t.toLowerCase()),n=[];for(const r of e){const a=Cs(i(r).toLowerCase()).indexOf(s);a<0||n.push({item:r,index:a})}return n.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},au=e=>e===!1||e==null?[]:e,On=(e,t,i)=>e.dispatchEvent(new CustomEvent(t,{detail:i})),lu=(e,t,i)=>E(s=>{t?.(s),On(e,i,s)},[t]),cu=[],uu=e=>(...t)=>{let i;const s=()=>{i&&cancelAnimationFrame(i)};return s(),i=requestAnimationFrame(()=>{i=void 0,e(...t)}),s},du=({value:e,text:t,onChange:i,onText:s,onSelect:n,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:f,defaultIndex:p,externalSearch:m,...g})=>{const _=F(()=>(c??$a)(l),[c,l]),{active:y,focused:b,onFocus:v,setClosed:w}=eu(g),$=!t,S=F(()=>t?.trim(),[t]),A=pt(),z=lu(A,s,"text"),M=E(L=>{i?.(L,()=>w(!0)),On(A,"value",L)},[i]),[V,Z]=G([]),B=F(()=>Promise.resolve(typeof a=="function"?a({query:S,active:y}):a).then(au),[a,y,S]),N=F(()=>ut(e),[e]);k(()=>B.then(Z),[B]),ru({focused:b,empty:$,limit:r,value:N,onChange:M,onText:z}),k(()=>{!b&&!h&&z("")},[b,h]);const I=Qt({onText:z,onChange:M,value:N,limit:r,min:o,keepQuery:h,keepOpened:d,setClosed:w,onSelect:n}),[,,J]=nu(B);return{active:y,query:S,textual:_,value:N,source$:B,loading:J==="pending",items:F(()=>{if(!y)return cu;const L=f?V:[...N,...We(N,Zs(u))(V)];return m?L:ou(L,S,_)},[V,y,S,_,$,N,f,u,m]),onClick:E(()=>w(!1),[]),onFocus:v,onText:E(L=>{z(L.target.value),w(!1)},[z,t,w]),onSelect:E(L=>{I.onSelect?.(L,I);const{onChange:T,onText:j,limit:at,min:Zt,value:An,keepQuery:Rn,keepOpened:kn,setClosed:Nn}=I;Rn||j(""),kn||Nn(!0);const te=ut(An),xi=te.includes(L);xi&&te.length===Zt||T((xi?We(L)(te):[...te,L]).slice(-at))},[I]),onDeselect:E(L=>I.onChange(We(L)(I.value)),[I]),defaultIndex:S!==void 0&&S?.length>0?0:p}},hu=e=>{const t=e.shadowRoot.querySelectorAll(".chip"),i=e.shadowRoot.querySelector(".badge");i.hidden=!0;for(const a of t)a.hidden=!1;const n=e.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<t.length;r++){const l=t[r].getBoundingClientRect();if(!(l.x+l.width<=n.x+n.width-24))break}const o=t.length-r;for(i.querySelector("span").textContent="+"+o.toString(),i.hidden=o<1;r<t.length;r++)t[r].hidden=!0},fu=({value:e,active:t,wrap:i,limit:s})=>{const n=pt(),r=!(i||s==1),o=F(()=>uu(()=>hu(n)),[]),[a,l]=G(0);Ge(()=>{if(!r)return;const c=n.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),Ge(()=>r?o():void 0,[r,a,t,e])},pu=["input","control","label","line","error","wrap"].map(e=>`${e}: input-${e}`).join(),gu=[Cc({apply({rects:e,elements:t}){Object.assign(t.floating.style,{minWidth:`${Math.max(e.reference.width,e.floating.width)}px`})}}),...wn],mu=({active:e,isSingle:t,showSingle:i})=>e?!(t&&!i):!1,_u=e=>{const{active:t,invalid:i,errorMessage:s,label:n,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onFocus:h,onClick:f,onDeselect:p,value:m,limit:g,min:_,showSingle:y,items:b,source$:v,placement:w,loading:$,chipRenderer:S}=e,A=pt(),z=g==1,M=z&&m?.[0]!=null,{styles:V,setReference:Z,setFloating:B}=Ec({placement:w,middleware:gu});k(()=>(A.addEventListener("focusin",h),A.addEventListener("focusout",h),()=>{A.removeEventListener("focusin",h),A.removeEventListener("focusout",h)}),[h]),tn({focus:()=>A.shadowRoot?.querySelector("#input")?.focus()},[]);const N=$||b.length>0||u!=null&&u.length>0;return C`<cosmoz-input
				id="input"
				part="input"
				${Gt(Z)}
				.label=${n}
			...
			${D(mu({active:t,isSingle:M,showSingle:y}),()=>Yc({...e,items:b,multi:!z,setFloating:B,styles:{...V,display:N?void 0:"none"}},D($,()=>C`<cosmoz-autocomplete-skeleton-span></cosmoz-autocomplete-skeleton-span>`,()=>D(u!=null&&u.length>0&&b.length===0,()=>C`<slot name="no-result"></slot>`))))}`},$n=e=>{const t={...e,...du(e)};return fu(t),_u(t)},Tn=["disabled","invalid","no-label-float","always-float-label","text-property","value-property","limit","min","show-single","preserve-order","keep-opened","keep-query","default-index","external-search","item-height","item-limit","wrap"],yu=e=>{const{onChange:t,onText:i,...s}=e,[n,r]=tr("value");return k(()=>{e.onChange!=null&&console.warn("onChange is deprecated; use value-changed and lift instead")},[]),$n({...s,value:n,onChange:E((o,...a)=>{r(o),t?.(o,...a)},[t]),onText:E(o=>{e.text=o,i?.(o)},[i])})},Ln=[di(tu)];customElements.define("cosmoz-autocomplete-ui",rt($n,{observedAttributes:Tn,styleSheets:Ln}));customElements.define("cosmoz-autocomplete",rt(yu,{observedAttributes:Tn,styleSheets:Ln}));lt`
	.input-inline-file {
		position: relative;
	}
...
</svg>`;export{Ga as a,Sl as b,rt as c,rl as d,xt as e,qt as i,Te as l,R as o,el as r,kl as u};
