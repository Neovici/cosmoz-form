import{o as p,n as h,w as X,b as o,t as j,v as ee,a as w,i as k,x as te,m as ae,l as O,c as L,u as se,d as C,e as S,f as T,A as _}from"./iframe-D2dwe2z8.js";import{s as ie,r as oe,a as re,b as ne,i as x,c as le,d as de,e as ce,v as ue,E as q,f as me,u as A,g as u,t as y,n as g,h as pe,j as P,k as ge,l as ye,m as ve}from"./inline-file-BjxF6ZSw.js";import{a as I}from"./autocomplete-Dwr6sJeh.js";import{u as fe}from"./use-items-Bdd33lQr.js";import"./preload-helper-PPVm8Dsz.js";const be=({slot:e,title:t,className:a,width:s="24",height:i="24",styles:n}={})=>o`
  <svg
    slot=${p(e)}
...
`,D=Symbol("key"),$e=e=>{const t={...e};return Object.assign(t,{[D]:t})},he=e=>o`<cosmoz-button
	...
	>
		...
		${[ne({...r,values:e,fields:n,context:d??{},touched:c,onChange:l=>a(t,{...k(l,e),[D]:e?.[D]??e}),invalid:!1,load:w,onReset:w,onValues:w}),h(s,l=>he(e&&l&&(()=>l(t)))),h(i,K)]}
		...
		${ee({items:[{[D]:0},...e,...i?[$e(i)]:[]],keyFunction:n,renderItem:(m,E)=>{switch(!0){case E===0:return o`<div class="headers">
							${re({fields:t})}
							${h(l.remove!=null,K)}
						</div>`;case(i!=null&&E===e.length+1):return a(m,E-1,{...l,fields:t,remove:void 0,removePlaceholder:l.remove!=null,update:(H,Z)=>c(H,{...m,...Z})});default:return a(m,E-1,{...l,fields:t,update:c})}},scroller:d})}
	</div>`,Se=({fields:e})=>j`
	${ie}
	${oe({fields:e})}
`,Ee=x(({id:e,error:t,onChange:a,accept:s,multiple:i,value:n,values:d,autoReset:c})=>o`<div class="input input-file" name=${e}>
			<input
				class="file"
				type="file"
				name=${e}
		...
		</div>`),Re=({id:e,label:t,error:a,disabled:s,warning:i,onChange:n,value:d,title:c,description:r})=>o`<cosmoz-toggle
	...
	>`,Fe=x(Re),ke=e=>e===void 0||typeof e=="object",Ae=e=>x(({id:t,label:a,variant:s,error:i,warning:n,disabled:d,onChange:c,value:r})=>{if(ke(r))return[o`<cosmoz-input
				...
				></cosmoz-input>`]}),V=Ae("date"),Pe=e=>Number.isNaN(e)||typeof e!="number"?0:e,we=new Intl.NumberFormat(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),Ce=e=>we.format(Pe(e)),G=({value:e,values:t,field:a,error:s,context:i})=>{const{id:n,suffix:d,warning:c,label:r,variant:l,format:m=Ce}=a;return[o`<style>
			...
			?invalid=${!!s}
			.errorMessage=${s}
			>${ce({suffix:k(d,e,t,a,i),warning:k(c,e,t,a,i)})}</cosmoz-input
		>`]},Oe=({initial:e,rules:t,fields:a,context:s,touched:i})=>{const n=se({fields:a}),d=C(()=>[m=>({[q]:ue(n.fields,m,s)})],[n,s]),{items:c,...r}=fe({initial:e,rules:C(()=>[...t??[],d],[t,d]),context:s,touched:i}),l=C(()=>c.some(m=>m[q]),[c]);return{...r,items:c,invalid:l}},N=()=>j`
	:host {
		display: flex;
...
`,He={title:"Add"},z=["Electronics","Clothing","Food","Books","Toys"],Te=["USD","EUR","GBP","JPY","CAD"],xe=["new","sale","popular","limited","exclusive","seasonal"],Q={name:"",price:0,sku:"",active:!0,category:"",tags:[],attachments:[],document:void 0,dropFiles:[]},J=[{id:"name",label:"Product name",hint:"Best practice: keep it under 50 characters.",input:y,validate:[u,e=>e?!1:"Name is required"]},{id:"price",label:"Price",hint:"Enter the price in euros. Must be greater than 0.",input:g,min:0,validate:[u,e=>e>0?!1:"Price must be greater than 0"]},{id:"sku",label:"SKU",hint:"Stock Keeping Unit",input:y},{id:"category",label:"Category",input:I,options:z,mode:"select",preserveOrder:!0,validate:[u,e=>e?!1:"Category is required"]},{id:"tags",label:"Tags",input:I,options:xe,preserveOrder:!0,validate:[u,e=>e.length>0?!1:"At least one tag is required"]},{id:"attachments",label:"Attachments",input:Ee,multiple:!0},{id:"document",label:"Document",input:pe},{id:"active",label:"Active",input:Fe}],Y=[[e=>e.name?{}:{name:e.name}]],Ne=()=>{const e=A({initial:Q,fields:J,rules:Y,touched:!0});return o`
    ...
    `};customElements.define("story-add-fields",S(Ne));const v=()=>o`<story-add-fields></story-add-fields>`;v.storyName="Fields";const ze=()=>new Promise(e=>setTimeout(e,2e3)),Le=()=>{const e=A({initial:Q,fields:J,rules:Y,touched:!0}),[t,a]=T(void 0),s=()=>{if(e.invalid)return;const i=ze();a(i),i.then(()=>a(void 0))};return o`
        <style>
            ${N()}
        </style>
        <div class="story-stack">
